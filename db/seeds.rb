...
SeabTopic.create( topic: "Market System",
...
SeabSubTopic.create( topic: "Scarcity, Choice and Opportunity Cost",
              seab_topic_id: "1",
) #seab_sub_topic_id:1

SeabSubTopic.create( topic: "Resource Allocation in Competitive Markets",
              seab_topic_id: "1",
) #seab_sub_topic_id:2

SeabSubTopic.create( topic: "Firms and How They Operate",
              seab_topic_id: "1",
) #seab_sub_topic_id:3

SeabTopic.create( topic: "Market Failure and Government Intervention",
              description: "This theme examines the nature of market failure, its causes and possible policy remedies.",
              subject_id: "2",
) #seab_topic_id:2

SeabSubTopic.create( topic: "Market Failure",
              seab_topic_id: "2",
) #seab_sub_topic_id:4

SeabSubTopic.create( topic: "Government Intervention in The Market",
              seab_topic_id: "2",
) #seab_sub_topic_id:5

SeabTopic.create( topic: "National and International Economy",
...
SeabSubTopic.create( topic: "Key Economic Indicators",
              seab_topic_id: "3",
) #seab_sub_topic_id:6

SeabSubTopic.create( topic: "How The Macroeconomy Works",
              seab_topic_id: "3",
) #seab_sub_topic_id:7

SeabSubTopic.create( topic: "International Economics",
              seab_topic_id: "3",
) #seab_sub_topic_id:8
