...
class SummariesControllerTest < ActionController::TestCase
  ...
  test "should create summary" do
    assert_difference('Summary.count') do
      post :create, summary: { lesson_id: @summary.lesson_id, position: @summary.position, summary: @summary.summary }
    end
  ...
  test "should update summary" do
    put :update, id: @summary, summary: { lesson_id: @summary.lesson_id, position: @summary.position, summary: @summary.summary }
    assert_redirected_to summary_path(assigns(:summary))
  end
